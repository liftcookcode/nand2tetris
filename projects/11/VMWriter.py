...
class VMWriter:
    ''' A jack to VM writer, used by the compiler to output the code matching to the analyzed code '''
    ...
    def write_if(self, label):
        ''' Write an if-goto used in while/if. Used to jump to label if the condition doesnt hold'''
        self.ostream.write('not\n') # Negate to jump if the condition doesn't hold
