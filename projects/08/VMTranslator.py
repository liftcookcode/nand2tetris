...
def parse(line):
    ''' Parse a vm line
        @return the parsed line as a list of the keyword/arguemnts'''
...
def translate(parsed_line, filename):
    ...
    # Program flow instructions
        ...
        return vm_flow.label.label(name=arg1, function=last_func)
...
def process(file, filename):
    ...
    @return a generator for the translation of commands'''
...
def translate_file(file_path, output=None):
    ...
    @output A supplied output file. If None write the result to a file matching the input file's name'''
    ...
    with open(file_path, 'r') as file:
        ...
        result = process(file, file_path_no_ext)
